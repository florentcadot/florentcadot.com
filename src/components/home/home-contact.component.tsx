      ...
      <div className="home-contact-content">
        <div>
          <div className="home-contact-item">
            <img className="contact-image" src={GmailImage} />
            <a href="mailto:florentcadot.dev@gmail.com">
              {' '}
              florentcadot.dev@gmail.com
            </a>
          </div>
          <div className="home-contact-item">
            <img className="contact-image" src={LinkedinImage} />
            <a
              target="_blank"
          ...
          <div className="home-contact-item">
            <img className="contact-image" src={MaltImage} />
            <a
              target="_blank"
          ...
          <div className="home-contact-item">
            <img className="contact-image" src={GithubImage} />
            <a
              target="_blank"
